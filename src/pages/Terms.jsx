    ...
    <div className="min-h-screen bg-background text-ink font-body">
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="space-y-4 text-muted leading-relaxed">
          ...
          <p>By using the ProPlumb website, you agree to these terms.</p>
          ...
          <p>ProPlumb is not liable for damages resulting from misuse of plumbing systems or unauthorized modifications.</p>
        </div>
      </div>
    </div>
  )
