    ...
    <div className="min-h-screen bg-background text-ink font-body">
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="space-y-4 text-muted leading-relaxed">
          ...
          <p>ProPlumb ("we", "our", "us") respects your privacy. This policy explains how we collect and use your personal information.</p>
          ...
          <p>For questions about this policy, contact us at info@proplumb.com.</p>
        </div>
      </div>
    </div>
  )
